...
const WishlistProvider = ({ children })=>{
    ...
    const addToWishlist = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "WishlistProvider.useCallback[addToWishlist]": (shoeId, shoeName)=>{
            setWishlist({
    ...
    const removeFromWishlist = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "WishlistProvider.useCallback[removeFromWishlist]": (shoeId, shoeName)=>{
            setWishlist({
                "WishlistProvider.useCallback[removeFromWishlist]": (prev)=>{
                    const newWishlist = prev.filter({
                        "WishlistProvider.useCallback[removeFromWishlist].newWishlist": (id)=>id !== shoeId
                    }["WishlistProvider.useCallback[removeFromWishlist].newWishlist"]);
                    if (newWishlist.length < prev.length) {
                        toast({
    ...
    const isInWishlist = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "WishlistProvider.useCallback[isInWishlist]": (shoeId)=>{
...
_s(WishlistProvider, "whPac7z/ssAubHnTdjBwCW3VQPc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
    ];
});
...
_s(Header, "qzpwnev7TJMKhQXXAEHmic9QaHQ=", false, function() {
    return [
...
//# sourceMappingURL=src_544ca5c1._.js.map